...
# NSYS_FILE_NAME = "/mnt/ssd/mayiling.myl/run_vllm/nsys_file_{}"
...
# Server base command
base_server_cmd = [
    "nsys", "profile", "-t", "cuda,cudnn,nvtx,cublas,osrt",
    "-o", "/mnt/ssd/mayiling.myl/run_vllm/nsys_file",
    "-w", "true",
    "-f", "true",
...
if __name__ == "__main__":
    for idx, exp in enumerate(experiments):
        ...
        # nsys_file_path = NSYS_FILE_NAME.format(idx + 1)
        ...
        # server_cmd.append("-o")
        # server_cmd.append(nsys_file_path)
